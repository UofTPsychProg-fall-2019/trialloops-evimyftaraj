...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/evimyftaraj1/Documents/GitHub/trialloops-evimyftaraj/stroop_lastrun.py',
...
trials = data.TrialHandler(nReps=5, method='random', 
    ...
    trialList=data.importConditions('stroop.xlsx'),
